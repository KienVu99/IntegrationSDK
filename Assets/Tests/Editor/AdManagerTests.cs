...
public class AdManagerTests
{
    private class FakeAdProvider : IAdProvider
    {
        ...
        public string LastBannerPlacement;
        public bool BannerHidden;
        ...
        public void ShowBanner(string placement) => LastBannerPlacement = placement;
        public void HideBanner() => BannerHidden = true;
    }
    ...
    private class ThrowingAdProvider : IAdProvider
    {
        ...
        public void ShowBanner(string placement) => throw new Exception("boom");
        public void HideBanner() => throw new Exception("boom");
    }
    ...
    [Test]
    public void ShowBanner_ForwardsToRegisteredProvider()
    {
        var provider = new FakeAdProvider();
        AdManager.RegisterProvider(provider);
        ...
        Assert.AreEqual("home_screen", provider.LastBannerPlacement);
        Assert.IsTrue(provider.BannerHidden);
    }
